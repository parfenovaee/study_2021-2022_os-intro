...
![Базовая настройка git](image/5.png){ #fig:005 width=70% }
...
![Создание репозитория курса](image/15.1.png){ #fig:017 width=70% }
...
![Настройка каталога курса](image/16.2.png){ #fig:019 width=70% }
